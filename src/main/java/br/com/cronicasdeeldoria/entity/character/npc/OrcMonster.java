...
public class OrcMonster extends Npc {
  private int xpReward = 45;
  /**
  ...
  public OrcMonster(String name, boolean isStatic, String dialog, int x, int y, String skin, int playerSize, boolean interactive, boolean autoInteraction) {
